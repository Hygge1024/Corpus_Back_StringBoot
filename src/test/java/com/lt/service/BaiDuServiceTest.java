...
public class BaiDuServiceTest {
    ...
    void testBaidu() throws IOException, InterruptedException {
        ...
        String end = baiduService.Toriginaltext(
                "http://8.137.53.253:1337/uploads/dry_conditions_threaten_wild_horses_in_western_us_10230dd8ed.mp3", 2,
                "1uoRnTwzQAD9Zh2dniw90HIH", "b1dn5GiMqRglAGyGia23dD1nbXVb1Pri");
    ...
    void getWenXinResponse() throws IOException {
        ...
        List<String> keywords = Arrays.asList("keyword1"); // 这里添加你的测试关键词
        baiduService.WenXin_Value("sampleText1", "sampleText2", keywords, "api_key", "security_key");
    }
    @Test
    void getAcText() throws IOException, InterruptedException {
        String url1 = "http://8.137.53.253:1337/uploads/24_0106_3c9bf7735c.mp3";
        String url2 = "http://8.137.53.253:1337/uploads/24_0106_cbb236d956.mp3";
//        String url2 = "http://music.163.com/song/media/outer/url?id=2051592404.mp3";
//        String ccc = baiduService.Toriginaltext(url1,2, "1uoRnTwzQAD9Zh2dniw90HIH", "syiiokIt4xLkDMPsGAWvteCL6K9VmjQZ");//识别是是英文
        String ccc = baiduService.Toriginaltext(url2,1, "1uoRnTwzQAD9Zh2dniw90HIH", "syiiokIt4xLkDMPsGAWvteCL6K9VmjQZ");//识别是是中文
