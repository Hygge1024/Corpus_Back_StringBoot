...
public class BaiDuServiceTest {
    ...
    void getWenXinResponse() throws IOException {
        ...
        baiduService.WenXin_Value("sampleText1", "sampleText2", keywords, "api_key", "security_key", contentA, 0);
    }
    ...
    void getAcText() throws IOException, InterruptedException {
        ...
        // String ccc = baiduService.Toriginaltext(url1,2, "1uoRnTwzQAD9Zh2dniw90HIH",
        // "syiiokIt4xLkDMPsGAWvteCL6K9VmjQZ");//识别是是英文
        String ccc = baiduService.Toriginaltext(url2, 1, "1uoRnTwzQAD9Zh2dniw90HIH",
                "syiiokIt4xLkDMPsGAWvteCL6K9VmjQZ");// 识别是是中文
